"""
Contains numba-optimized functions for when the kernel is set as an integer.
"""
...
# API public
__all__ = ['int_sliding_nanmedian_3d', 'int_sliding_nanmean_3d']
...
@njit(parallel=True)
def int_sliding_nanmedian_3d(data: np.ndarray, size: int) -> np.ndarray:
    """
...
@njit(parallel=True)
def int_sliding_nanmean_3d(data: np.ndarray, size: int) -> np.ndarray:
    """
